...
- [ ] Describe Middleware?
    Interupts the flow of reqs and res throught the Express assembly line. Each piece of middleware works on the req res in different ways.

- [ ] Describe a Resource?
    A resource is the data that the api retrieves.

- [ ] What can the API return to help clients know if a request was successful?
    An api can return the resource that was pulled, modified or deleted.
